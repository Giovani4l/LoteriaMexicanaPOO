...
- **Personalización de Tablas:** Posibilidad de crear tablas de 4x4 o 5x5, con la opción de elegir entre configuraciones simples o dobles.
- **Mecánica de Tabla Doble:** Cada tabla puede contener cartas repetidas al azar, añadiendo un elemento estratégico.
...
- **Auto-canto con Velocidades:** Sistema de auto-canto con velocidades ajustables (rápido, normal, lento) para automatizar el ritmo del juego.
- **Formatos de Victoria Dinámicos:** Modificación y adición de formatos de victoria (línea, columna, diagonal, cruz, tabla llena) durante una partida en curso.
...
## 🎮 Flujo del Juego
1. **Creación:** El Host crea la sala y define las configuraciones de tabla (4x4/5x5, simple/doble).
...
5. **Marcado:** Los jugadores marcan sus fichas.
6. **Victoria:** El sistema valida condiciones de victoria configuradas dinámicamente y anuncia al ganador.
